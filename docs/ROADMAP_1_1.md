...
> Ход выполнения и фактически пройденные проверки: [ROADMAP_PROGRESS.md](ROADMAP_PROGRESS.md).
> Галочки в разделе milestones описывают целевые критерии, а не текущий статус.
