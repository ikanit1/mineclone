 ...
 */
public class RenderVersionShot {

    private static final int W = 1280, H = 720;
    private static final int RADIUS = 4;
    private static final long SEED = 20260615L;
    ...
    public static void main(String[] args) throws Exception {
        ...
        int surface = surfaceOf(world, 0, 0);
        Vector3f weatherEye = new Vector3f(0.5f, surface + 3.6f, 0.5f);
        ...
        // Ровно те же четыре времени суток и тот же сид, что снял ShotJune:
        // сравнение должно показывать разные версии, а не разные места.
        Shot[] shots = {
            new Shot("day",   1.35f, 0f, 0f, 0f, 0.15f, 1f, 0f, 0, -0.12f, 0.5f, 0.2f,
                    new Extra(0f, 0.0018f, 0f, true, false, 0f, 0f, 1f)),
            new Shot("dusk",  2.75f, 0f, 0f, 0f, 0.25f, 1f, 0f, 0, -0.12f, 0.6f, 0.2f,
                    new Extra(0f, 0.0022f, 0f, true, false, 0f, 0f, 1f)),
            new Shot("dawn",  0.30f, 0f, 0f, 0f, 0.20f, 1f, 0f, 0, -0.12f, 0.6f, 0.2f,
                    new Extra(0.030f, 0.0018f, 0f, true, false, 0f, 0f, 1f)),
            new Shot("night", 4.10f, 0f, 0f, 0f, 0.10f, 1f, 0.55f, 0, -0.12f, 0.4f, 0.2f,
                    new Extra(0f, 0.0015f, 0f, true, false, 0f, 0f, 1f)),
        };

        Files.createDirectories(Path.of("out-test/version-shot"));
        ...
        for (Shot s : shots) {
            ...
            Vector3f fwd = new Vector3f(0.30f, s.lookUp, -1f).normalize();
            ...
            previous = img;
            ImageIO.write(img, "png", Path.of("out-test/version-shot/now-" + s.name + ".png").toFile());
            int err = glGetError();
